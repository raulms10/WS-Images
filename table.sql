...
--
-- Siempre debemos añadir el atributo id en las propiedades  de nuestra tabla 
-- como clave primaria porque Loopback lo agrega  por defecto en el modelo
--
